...
In this exercise, you created a web app in Azure and then deployed your ASP.NET Core web application to Web Apps by using the Azure CLI and the Kudu zip file deployment utility.
