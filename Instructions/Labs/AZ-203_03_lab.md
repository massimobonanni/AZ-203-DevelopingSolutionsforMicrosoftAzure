...
1.  Record the value in the **Primary Blob Service Endpoint** box. You'll use this value later in this lab.

1.  Open the **Access Keys** section of the storage account instance.

1.  Record the value in the **Storage account name** box and any of the **Key** boxes. You'll use these values later in this lab.
...
1.  Access the **mediastor\*** storage account that you created earlier in this lab.
...
### Exercise 3: Access containers by using the .NET Core SDK

#### Task 1: Create .NET Core project

1.  Using Visual Studio Code, open the **Allfiles (F):\\Allfiles\\Labs\\03\\Starter\\BlobManager** folder.

1.  Using a terminal, create a new .NET Core project named **BlobManager** in the current folder:
