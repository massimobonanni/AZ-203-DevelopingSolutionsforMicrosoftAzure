...
1.  Find and record the value of the **Application (client) ID** box. You'll use this value later in the lab.

1.  Find and record the value of the **Directory (tenant) ID** box. You'll use this value later in the lab.
