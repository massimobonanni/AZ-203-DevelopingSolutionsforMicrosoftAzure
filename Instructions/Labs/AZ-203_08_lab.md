...
1.	Access the **httpapi\*** web app that you created earlier in this lab. 

1.  Open the **httpapi\*** web app in your browser.
...
1.  Return to the Azure portal and the **Web App** blade for the **httpapi\*** web app. 
