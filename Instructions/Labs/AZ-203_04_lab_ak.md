...
1.  Select the **Trash Can** icon to close the currently open terminal and any associated processes.
...
1.  Return to the **Visual Studio Code** window, and then select the **Trash Can** icon to close the currently open terminal and any associated processes.
